// src/app/blog/caregiver-support/page.tsx
// All Family Health Care — Caregiver Support Blog Hub
...
export const metadata: Metadata = {
  title: "Caregiver Support Guides",
  description:
    "Practical help for family members managing care for a loved one at home — from burnout to legal planning, written by Chicago's home health professionals.",
};

const articles = getArticlesByHub("caregiver-support");
...
export default function CaregiverSupportPage() {
  return (
    <>
      ...
      <div className="bg-bg px-6 py-12 md:px-8 md:py-16 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="max-w-[560px] text-base font-light leading-relaxed text-body">
            Practical help for family members managing care for a loved one at home — covering burnout, communication, legal planning, and finding professional support.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border-y border-border px-6 py-6 md:px-8 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-heading text-sm font-semibold text-charcoal">
            Overwhelmed by caregiving responsibilities? We can help.
          </p>
      ...
      >
        <div className="mx-auto max-w-[1400px]">
          <h2 id="articles-heading" className="sr-only">Caregiver Support Articles</h2>
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
            <p className="font-heading text-base font-bold text-charcoal">
              Caregiver support starts with a phone call.
            </p>
            <p className="mt-1 text-sm font-light text-body">
              Our care coordinators understand what families go through — and can help you find relief.
            </p>
          </div>
