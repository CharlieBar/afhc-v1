// src/app/blog/senior-health/page.tsx
// All Family Health Care — Senior Health Blog Hub
...
export const metadata: Metadata = {
  title: "Senior Health Guides",
  description:
    "Health guides for older adults and the families who care for them — from our licensed clinical team in Chicago.",
};

const articles = getArticlesByHub("senior-health");
...
export default function SeniorHealthPage() {
  return (
    <>
      ...
      <div className="bg-bg px-6 py-12 md:px-8 md:py-16 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="max-w-[560px] text-base font-light leading-relaxed text-body">
            Health guides for older adults and the families who care for them — written and reviewed by our licensed clinical team.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border-y border-border px-6 py-6 md:px-8 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-heading text-sm font-semibold text-charcoal">
            Have questions about senior home health care?
          </p>
      ...
      >
        <div className="mx-auto max-w-[1400px]">
          <h2 id="articles-heading" className="sr-only">Senior Health Articles</h2>
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
            ...
            <p className="mt-1 text-sm font-light text-body">
              Call us — most services are covered by Medicare at no out-of-pocket cost.
            </p>
          </div>
