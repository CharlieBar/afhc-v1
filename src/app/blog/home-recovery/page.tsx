// src/app/blog/home-recovery/page.tsx
// All Family Health Care — Home Recovery Blog Hub
...
export const metadata: Metadata = {
  title: "Home Recovery Guides",
  description:
    "Recovering from surgery, illness, or hospitalization at home — guides written by Chicago's licensed home health professionals.",
};

const articles = getArticlesByHub("home-recovery");

export default function HomeRecoveryPage() {
  return (
    <>
      {/* Breadcrumbs */}
      ...
      <div className="bg-bg px-6 py-12 md:px-8 md:py-16 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="max-w-[560px] text-base font-light leading-relaxed text-body">
            What to expect after surgery, hospitalization, or serious illness — and how to recover safely and effectively at home with professional support.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border-y border-border px-6 py-6 md:px-8 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-heading text-sm font-semibold text-charcoal">
            Planning a discharge? We can coordinate care before your patient leaves the hospital.
          </p>
      ...
      >
        <div className="mx-auto max-w-[1400px]">
          <h2 id="articles-heading" className="sr-only">Home Recovery Articles</h2>
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
            ...
            <p className="mt-1 text-sm font-light text-body">
              We can have a nurse at your home within 24–48 hours of discharge. Call to get started.
            </p>
          </div>
