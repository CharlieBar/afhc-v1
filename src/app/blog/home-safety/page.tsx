// src/app/blog/home-safety/page.tsx
// All Family Health Care — Home Safety Blog Hub
...
export const metadata: Metadata = {
  title: "Home Safety Guides for Seniors",
  description:
    "Fall prevention, home modifications, and safety tips for seniors — written by Chicago's licensed occupational therapists and home health professionals.",
};

const articles = getArticlesByHub("home-safety");
...
export default function HomeSafetyPage() {
  return (
    <>
      ...
      <div className="bg-bg px-6 py-12 md:px-8 md:py-16 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="max-w-[560px] text-base font-light leading-relaxed text-body">
            Fall prevention, home modifications, and safety assessments — practical guidance to help your loved one stay safe at home.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border-y border-border px-6 py-6 md:px-8 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-heading text-sm font-semibold text-charcoal">
            Our occupational therapists perform professional home safety assessments — covered by Medicare.
          </p>
      ...
      >
        <div className="mx-auto max-w-[1400px]">
          <h2 id="articles-heading" className="sr-only">Home Safety Articles</h2>
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
            ...
            <p className="mt-1 text-sm font-light text-body">
              Our occupational therapists assess and address fall risks — at no cost for qualifying Medicare patients.
            </p>
          </div>
