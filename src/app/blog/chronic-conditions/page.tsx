// src/app/blog/chronic-conditions/page.tsx
// All Family Health Care — Chronic Conditions Blog Hub
...
export const metadata: Metadata = {
  title: "Chronic Conditions Guides",
  description:
    "Managing heart disease, COPD, diabetes, and other ongoing conditions at home — guides written by Chicago's licensed home health professionals.",
};

const articles = getArticlesByHub("chronic-conditions");
...
export default function ChronicConditionsPage() {
  return (
    <>
      ...
      <div className="bg-bg px-6 py-12 md:px-8 md:py-16 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px]">
          ...
          <p className="max-w-[560px] text-base font-light leading-relaxed text-body">
            Managing heart disease, COPD, diabetes, and other ongoing conditions safely at home — with practical guidance from our clinical team.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border-y border-border px-6 py-6 md:px-8 lg:px-10 xl:px-14">
        <div className="mx-auto max-w-[1400px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-heading text-sm font-semibold text-charcoal">
            Managing a chronic condition at home? Skilled nursing can help prevent hospitalizations.
          </p>
      ...
      >
        <div className="mx-auto max-w-[1400px]">
          <h2 id="articles-heading" className="sr-only">Chronic Conditions Articles</h2>
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          <div>
            <p className="font-heading text-base font-bold text-charcoal">
              Need skilled nursing for chronic disease management?
            </p>
            <p className="mt-1 text-sm font-light text-body">
              Call us — Medicare covers skilled nursing for qualifying patients managing chronic conditions at home.
            </p>
          </div>
